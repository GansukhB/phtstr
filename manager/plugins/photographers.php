<?php
	...
	if($execute_nav == 1){
		...
		$nav_name = "Photographers"; // name of the nav that will appear on the page
	}
	else {
		
		// OPTIONS
			$image_upload     = 0; // number of images that can be uploaded per members item / 0 for no files
			$image_path       = "../uploaded_images/";
			$image_caption    = 0; // 1 on | 0 off / Allow captions on images
			$image_area_name  = "";
				
			$file_upload      = 0; // number of files that can be uploaded per members item / 0 for no files
			...
			$actions_page     = "actions_photographers.php"; // Actions page for processing forms
...
<script language="javascript">
	...
	function save_data() {
		if(document.data_form.name.value == "" || document.data_form.email.value == "" || document.data_form.password.value == ""){
			alert("Please enter a name, email & password");
		}
		else {
		...
		<tr>
			<td align="left">
				<table>
					...
					<tr>
						<td><b>Search Photographers for:</b> (first name, last name, email)<br>
				...
				<table cellpadding="0" cellspacing="0" bgcolor="#577EC4" width="100%" style="border: 1px solid #5B8BD8;" background="images/mgr_bg_texture.gif">
					...
					<tr>
						<td colspan="<? echo $colspan; ?>">
							<table width="100%">
								<tr>
									<td style="padding-left: 8px;"><font style="font-size: 13;"><b>Photographers</b></td>
					...
					<tr>
						<td colspan="<? echo $colspan; ?>">
								...
								<table width="100%" cellpadding="0" cellspacing="0">
									<tr>
										<td>
											Results: <b><? echo $members_rows; ?> Photographers</b> (<? echo $result_pages; ?> Pages)
										</td>
										<td align="right">
										Page:  
										<b>
									...
									<td bgcolor="#5E85CA" class="data_box">
										<table width="100%" cellpadding="0" cellspacing="0">
											<tr>
												...
												<td width="50%">
												<!--
													<font face="arial" color="#ffffff" style="font-size: 11;"><b>Subscription Created</b><br>
													<input type="text" name="added" value="<? echo $members->added; ?>" style="font-size: 13; font-weight: bold; width: 100%; border: 1px solid #000000;" maxlength="150">
												-->
												</td>
											</tr>
										</table>
									...
									<td bgcolor="#5E85CA" class="data_box">
										...
										<table cellpadding="0" cellspacing="0">
											<tr>
												...
												<? if($item_id  != "new"){ ?>
												<td><!--&nbsp;&nbsp;&nbsp;Subscription Ends: <? echo $sub_ends; ?>--></td>
												<? } ?>
											</tr>
										</table>									
									</td>
