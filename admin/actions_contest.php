<?php
  ...
  switch($_GET['pmode']){
    case "create":
      ...
      $query = "insert into contest (title, description, start, end) values('$title', '$description', '$start', '$end')";
    ...
    case "edit":
      ...
      $query = "update contest set title='$title', description='$description', start='$start', end='$end' where id='$id'";
