								...
								<table width="100%" border="0">
									...
									<tr>
										<td class="gallery_copy">
											<?PHP echo $renew_expired_message; ?><br /><br />
											
											<? if($setting->use_paypal == 1){ ?>										
												 Please <a href="public_actions.php?pmode=renew1&id=<?php echo $_GET['id']; ?>"><?PHP echo $renew_click_here; ?></a><?PHP echo $renew_sub_with_paypal; ?><br /><br />
											<?php } ?>
											
											<? if($setting->use_2checkout == 1){ ?>										
												Please <a href="public_actions.php?pmode=renew2&id=<?php echo $_GET['id']; ?>"><?PHP echo $renew_click_here; ?></a><?PHP echo $renew_sub_with_twoco; ?><br /><br />
											<?php } ?>
										</td>
									</tr>
								</table>
