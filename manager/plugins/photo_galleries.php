				...
				<table cellpadding="0" cellspacing="0" bgcolor="#577EC4" width="100%" style="border: 1px solid #5B8BD8;" background="images/mgr_bg_texture.gif">
					<?
						...
						?>
								...
								<td align="center" class="listing" onClick="window.location.href='mgr.php?nav=<? echo $nav; ?>&item_id=<? echo $pg->id; ?>&order_by=<? echo $order_by; ?>&order_type=<? echo $order_type; ?>'">
									<a href="mgr.php?nav=<? echo $nav; ?>&item_id=<? echo $pg->id; ?>&order_by=<? echo $order_by; ?>&order_type=<? echo $order_type; ?>" class="edit_links">[edit]</a>
								</td>
					...
					<tr>
						<td colspan="<? echo $colspan; ?>">
							<table width="100%">
								<tr>
									<td style="padding-left: 8px;"><font style="font-size: 13;"><b>Photo Galleries  -  </b></font><b><a href="./menu_creator.php" class="title_links" target="_blank"><img src="images/mgr_button_create.gif" border="0" alt="Update Main Site Menu"></a>&nbsp;</td>
							...
							<table width="80%" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td bgcolor="#5E85CA" class="data_box">
										...
										<input type="text" name="title" value="<? echo $pg->title; ?>" style="font-size: 13; font-weight: bold; width: 575; border: 1px solid #000000;"  maxlength="150">
									</td>
								</tr>
							<tr>
									<td bgcolor="#5E85CA" class="data_box">
