  ...
  $lang = strtolower($lang[0]);
	...
	unset($_SESSION['mgruser']);
		 ...
		 $cr = "\n";
                        ...
                        $ca_result = mysql_query("SELECT * FROM photo_galleries where active = '1' and nest_under = '0'" . $extrasql . " order by galorder", $db);
                          ...
                          {
                            if($ca->{'title_'.$_GET['lang']} != "")
                              $title1 = $ca->{'title_'.$_GET['lang']};
                          }
													//addslashes($title1);
					 ...
					 // level five output (sub sub sub sub category)------------------------------
                          ...
                          if($_GET['lang'] != "English" )
                          {
							...
							$output.= $cr . "];";
										...
										$filename = '../js/tree_items_'.$_GET['lang'].'.js';
