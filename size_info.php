								...
								<table width="100%" border="0">
									...
									<tr>
										...
										if($setting->size_info == 1){
											$print_info_result = mysql_query("SELECT name,size,article FROM sizes where visible = 1 order by sorder", $db);
											$print_rows = mysql_num_rows($print_info_result);
											if($print_rows < 1){
												echo $sizes_info_none;
											} else {
											while($print_info = mysql_fetch_object($print_info_result)){
											echo "<b>" . $print_info->name . "</b><br>";
											echo "<b>Size: </b>" . $print_info->size . "(px)<br>";
